package com.sryzzz.gateway.filter;

import com.sryzzz.gateway.component.HandleException;
import com.sryzzz.gateway.config.IgnoreUrlsConfig;
        ...
        try {
            ...
            if (entity.getStatusCode() != HttpStatus.OK) {
                return handleException.writeError(exchange,
                        "Token was not recognized, token: ".concat(access_token));
            }
